...
#'
#' @param the name of a dataframe (ex:'param.txt') with species parameters created by 'CreateSource'
#' @pref the name of a dataframe (ex:'pref.txt') with species interaction preferences created by 'CreateSource'
